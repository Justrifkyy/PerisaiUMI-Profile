...
@section('title', 'Create Department - Admin PERISAI')
...
@section('content')
    <div class="max-w-4xl">
        ...
        <div class="bg-gray-800 rounded-lg shadow-xl p-8">
            <h2 class="text-2xl font-bold text-white mb-6">Create New Department</h2>
            ...
            <form action="{{ route('admin.departments.store') }}" method="POST" enctype="multipart/form-data"
                ...
                <div>
                    ...
                    <textarea name="description" id="description" rows="4"
                        class="w-full px-4 py-3 bg-gray-700 border border-gray-600 rounded-lg text-white focus:ring-2 focus:ring-yellow-400">{{ old('description') }}</textarea>
                </div>
