<div
    class="bg-zinc-900 rounded-lg p-6 md:p-8 border border-gray-800 hover:border-yellow-400/50 transition-all duration-300">
    {{-- Section Title --}}
    <h2 class="text-xl md:text-2xl font-bold text-yellow-400 mb-4 pb-3 border-b border-gray-800">
        {{ $data['title'] }}
    </h2>
