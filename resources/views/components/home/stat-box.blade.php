<div
    class="{{ $box['bgClass'] }} rounded-3xl p-8 md:p-10 shadow-xl hover:shadow-2xl {{ $box['shadowClass'] }} transition-all duration-300 {{ $box['borderClass'] ? 'border ' . $box['borderClass'] : '' }}">
    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
        <!-- Left Side: Label Boxes -->
        <div class="flex flex-col">
            <!-- Title Box -->
            <div
                class="inline-block {{ $box['bgClass'] === 'bg-yellow-400' ? 'bg-gray-900 text-yellow-400' : 'bg-yellow-400 text-gray-900' }} px-4 py-2 rounded-lg w-fit">
