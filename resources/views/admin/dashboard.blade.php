...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        <!-- News Card -->
        <div class="bg-gray-800 rounded-2xl p-8 border border-gray-700 hover:border-yellow-400 transition-all duration-300 shadow-xl hover:shadow-2xl">
            <div class="mb-6">
        ...
        <!-- Departments Card -->
        <div class="bg-yellow-400 rounded-2xl p-8 transition-all duration-300 shadow-xl hover:shadow-2xl hover:shadow-yellow-400/50">
            <div class="mb-6">
    ...
    <div class="bg-gray-800 rounded-lg p-6 border border-gray-700 shadow-lg">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <button class="flex items-center justify-center px-6 py-4 bg-yellow-400 hover:bg-yellow-500 text-gray-900 font-semibold rounded-lg transition shadow-lg hover:shadow-yellow-400/50">
                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <button class="flex items-center justify-center px-6 py-4 bg-gray-700 hover:bg-gray-600 text-white font-semibold rounded-lg transition">
                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"></path>
                </svg>
                Add Department
            ...
            <a href="{{ url('/') }}" target="_blank" class="flex items-center justify-center px-6 py-4 bg-gray-700 hover:bg-gray-600 text-white font-semibold rounded-lg transition">
                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
