...
@section('title', 'Create Member - Admin PERISAI')
...
@section('content')
    <div class="max-w-4xl">
        ...
        <div class="bg-gray-800 rounded-lg shadow-xl p-8">
            <h2 class="text-2xl font-bold text-white mb-6">Create New Member</h2>
                ...
                <div>
                    ...
                    <select name="hierarchy" id="hierarchy" required
                        ...
                        @foreach($hierarchies as $value => $label)
                            <option value="{{ $value }}" {{ old('hierarchy') === $value ? 'selected' : '' }}>
                                {{ $label }}
                            </option>
                        @endforeach
                    </select>
