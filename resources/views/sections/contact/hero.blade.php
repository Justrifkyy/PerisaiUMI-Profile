@php
    $heroData = [
        ...
        'description' => 'Kami siap membantu Anda! Hubungi kami untuk informasi lebih lanjut tentang PERISAI UMI, program kegiatan, atau kerjasama. Tim kami akan merespons pertanyaan Anda dengan cepat.',
    ];
@endphp
