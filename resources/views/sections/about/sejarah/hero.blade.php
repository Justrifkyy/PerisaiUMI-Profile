...
<section class="relative bg-black h-[60vh] md:h-[70vh] flex items-center justify-start overflow-hidden">
    ...
    <div class="absolute inset-0">
        ...
        {{-- <img src="{{ asset($backgroundImage) }}" alt="{{ $title }}" class="w-full h-full object-cover"> --}}
    ...
    <div class="relative z-10 text-left px-4 sm:px-6 lg:px-8 ml-12 md:ml-20">
        ...
        <div class="space-y-2 animate-slide-up">
            @foreach($heroData['subtitle'] as $line)
    ...
    <div class="absolute bottom-0 left-0 right-0">
        {{-- <svg class="w-full h-16 md:h-24 text-gray-900" preserveAspectRatio="none" viewBox="0 0 1200 120"
            fill="currentColor">
            <path
