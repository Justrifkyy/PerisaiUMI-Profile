@php
    $heroData = [
        ...
        'description' => 'PERISAI UMI memiliki 6 departemen yang bekerja secara sinergis untuk mendukung pengembangan riset, inovasi, dan prestasi mahasiswa di berbagai bidang.',
        'cta' => [
